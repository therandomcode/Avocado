...
public class SignUpFarmerAddProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button addPhotosButton = findViewById(R.id.farmerAddProfilePictureButton);
        ...
        final Button finishButton = findViewById(R.id.signUpFarmerAddProfilePictureFinishButton);
        ...
        final Button backButton = findViewById(R.id.signUpFarmerAddProfilePictureBackButton);
...
//                Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            /// farmerAddProfilePictureImageView
            // farmerAddProfilePictureButton
            ImageView imageView = findViewById(R.id.farmerAddProfilePictureImageView);
